...
export const STRINGS = {
  ca: {
    ...
    newsletterSubtext: "Només novetats, no t'escriurem més d'un cop al mes.",
    ...
    densityTooltip: "fins a {max}m d'alçada {lenHint}",
  ...
  es: {
    ...
    newsletterSubtext: "Solo novedades, no te escribiremos más de una vez al mes.",
    ...
    newsletterMenu: "Recibir novedades",
    searching: "buscando…",
    ...
    densityTooltip: "hasta {max}m de altura {lenHint} ",
  ...
  en: {
    ...
    newsletterSubtext: "Only updates, we won't message you more than once a month.",
    ...
    densityTooltip: "up to {max}m  high {lenHint}",
