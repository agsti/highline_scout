"""Denmark-specific configuration and CLI for chunk precompute."""
...
_CRS: Final[str] = "EPSG:25832"
__all__ = ["main", "shared"]


@dataclass(frozen=True)
class Region:
    """One Danish precompute target and terrain-source configuration."""
...
REGIONS: tuple[Region, ...] = (
    Region("denmark", (440_000, 6_040_000, 900_000, 6_410_000), _CRS,
           "denmark_dhm_terrain", dtm_dhm.fetch),
)


def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="highliner-etl-chunk-denmark")
