"""Poland CLI adapter for country-scoped density aggregation."""
...
def main(argv: list[str] | None = None) -> None:
    """Build density layers for all precomputed Polish regions."""
    parser = argparse.ArgumentParser(prog="highliner-etl-density-poland")
