"""Vatican City CLI adapter for country-scoped density aggregation."""
...
def main(argv: list[str] | None = None) -> None:
    """Build density layers for the precomputed Vatican City envelope."""
    parser = argparse.ArgumentParser(prog="highliner-etl-density-vatican-city")
